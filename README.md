...
Quick start: `cargo fmt && cargo test` before sending changes, and `cargo run` to launch. MSRV is **Rust 1.92.0**. See [CONTRIBUTING.md](CONTRIBUTING.md) for the full workflow and release automation notes.
